...
| 职能组 | 编号 | 智能体名称 | 核心职责 |
| :--- | :--- | :--- | :--- |
| **指挥部** | 1 | Chief PM | 拆解需求，定义验收标准 (AC) |
| **指挥部** | 2 | System Architect | 定义 API 契约与数据库 Schema |
| **统筹组** | 3 | Builder | **搭建代码骨架 (TDD 的靶子)** |
| **后勤组** | 4 | Data Engineer | **解决“无数据可测”的死锁** |
| **后端 TDD** | 5 | Unit Test | **编写失败的后端测试** |
| **后端 TDD** | 6 | Backend Dev | **让后端测试通过** |
| **后端 TDD** | 7 | Refactor Specialist | 优化后端代码 |
| **前端 TDD** | 8 | Pixel-Perfect UI Dev | 实现 1:1 静态 UI (VDD) |
| **前端 TDD** | 9 | Frontend Router | 接入 API，处理状态 (BDD) |
| **前端 TDD** | 10 | UX | 优化 Loading、交互反馈 |
| **前端 QA** | 11 | UI Automation Test | **编写失败的组件功能测试** |
| **前端 QA** | 12 | Visual Regression Tester | **编写像素比对测试** |
| **安全组** | 13 | Blue Team | 注入安全基因，代码加固 |
